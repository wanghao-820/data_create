...
if __name__ == "__main__":
    ...
    print(test.get_clazz_master_info_field(clazz_id=1424, master_id=10706954,field='conversion_num'))
    print(test.get_clazz_master_info_field(clazz_id=1424, master_id=10706954,field='service_num'))
